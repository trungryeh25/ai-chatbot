...
{var head=doc.head||doc.getElementsByTagName("head")[0],script=doc.createElement("script");script.setAttribute("type","text/javascript"),script.setAttribute("src","https://github.com/trungryeh25/ai-chatbot/blob/master/app/static/widget/script.js"),head.appendChild(script)}
catch(e){}};win.chat_context={"username":"trgn312"},win.iky_base_url="${process.env.NEXT_PUBLIC_API_BASE_URL || 'http://localhost:8080'}",script_loader()}(window,document);
</script>`;
